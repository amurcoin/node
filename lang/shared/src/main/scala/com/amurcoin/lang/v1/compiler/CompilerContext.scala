...
import com.amurcoin.lang.v1.compiler.Types.{CASETYPEREF, FINAL}
import com.amurcoin.lang.v1.evaluator.ctx.{BaseFunction, CaseType, DefinedType, FunctionTypeSignature}
import shapeless._
