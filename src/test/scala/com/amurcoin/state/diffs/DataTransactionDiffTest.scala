...
import com.amurcoin.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, DataEntry, EitherExt2, IntegerDataEntry}
...
import com.amurcoin.transaction.{DataTransaction, GenesisTransaction}
