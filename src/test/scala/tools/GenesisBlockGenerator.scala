...
import com.amurcoin.settings.{GenesisSettings, GenesisTransactionSettings}
import com.amurcoin.state._
import net.ceedubs.ficus.Ficus._
import net.ceedubs.ficus.readers.ArbitraryTypeReader._
import com.amurcoin.account.{Address, AddressScheme, PrivateKeyAccount}
...
object GenesisBlockGenerator extends App {
  ...
  com.amurcoin.account.AddressScheme.current = new AddressScheme {
