...
val versionSource = Def.task {
  ...
  val versionFile      = (sourceManaged in Compile).value / "com" / "amurcoin" / "Version.scala"
...
inConfig(Compile)(
  Seq(
    mainClass := Some("com.amurcoin.Application"),
