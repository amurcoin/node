...
import com.amurcoin.consensus.FairPoSCalculator
import com.amurcoin.crypto
import com.amurcoin.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.amurcoin.it.api.SyncHttpApi._
import com.amurcoin.it.transactions.NodesFromDocker
import com.amurcoin.it.{NodeConfigs, WaitForHeight2}
...
import com.amurcoin.block.{Block, SignerData}
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("amurcoin.miner.enable = yes"))
      .buildNonConflicting()
